(() => {
    ...
    let catalogIconParent = document.querySelector(".catalog_icon");
    if (catalogIcon) catalogIconParent.addEventListener("click", (function() {
        ...
        document.documentElement.addEventListener("click", (function(e) {
            ...
            let target = e.target;
            if (target.classList.contains("main") || target.parentNode.parentNode.parentNode.classList.contains("spollers__body") || target.classList.contains("main__container") || target.parentNode.classList.contains("main__container") || target.parentNode.parentNode.classList.contains("main__container") || target.getAttribute("src") || target.classList.contains("banner__container")) for (let index = 0; index < Opens.length; index++) {
    ...
    let searchIconParent = document.querySelector(".search_icon");
    if (searchIcon) searchIconParent.addEventListener("click", (function() {
        searchIcon.classList.toggle("opensearch");
        searchIcon.parentNode.classList.toggle("opensearch");
        document.documentElement.addEventListener("click", (function(e) {
            let Opens = document.querySelectorAll(".opensearch");
            let target = e.target;
            if (target.classList.contains("main") || target.classList.contains("catalog_icon") || target.classList.contains("main__container") || target.parentNode.classList.contains("main__container") || target.classList.contains("banner__container")) for (let index = 0; index < Opens.length; index++) {
                const element = Opens[index];
                element.classList.remove("opensearch");
            }
        }));
    }));
    ...
    let homePage = document.querySelector(".main_home");
    if (homePage) {
        let imgSubVideos = document.querySelectorAll(".videobox_img img");
        for (let index = 0; index < imgSubVideos.length; index++) {
            imgSubVideos[index];
        }
    }
    window["FLS"] = false;
